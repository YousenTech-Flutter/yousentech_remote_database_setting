...
class KeyAndTokenScreen extends StatefulWidget {
  ...
  @override
  State<KeyAndTokenScreen> createState() => _KeyAndTokenScreenState();
}
      ...
      remoteDatabaseSettingController
          ...
          .then((value) async {
            if (value.status) {
              ...
              Get.offAll(() => KeyAndTokenScreen(isKeyScreen: false));
            } else {
              if (value.data != null) {
                supportTicketDialog(
                  context: Get.context!,
                  ...
                  onPressed: () async {
                    await remoteDatabaseSettingController
                        .sendTicket(
                          subscriptionId:
                              SharedPr.subscriptionDetailsObj!.subscriptionId
                                  .toString(),
                          message: value.message!,
